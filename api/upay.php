...
'signature' => $signature));
$res=curl_request('https://epay-delta.vercel.app/api/v1/order/create-transaction】',$data,'post');//发起Curl请求并获取返回数据到变量
//echo '<br/>换行符<br/>'; 
//echo $data;
//echo '<br/>换行符<br/>'; 
//echo $res;
...
echo $payamount;
echo 'USD';
echo '<br/>若上述为空则你没有填URL中的?n=*的参数';//用了$amount = (double)$_GET["n"]来提取参数
